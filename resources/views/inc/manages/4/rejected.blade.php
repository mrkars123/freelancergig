								...
								<tbody class="BodyGroup">
									<tr class="Row BodyRow ng-star-inserted">
										...
										<td class="Cell pr-10 Cell-vt BodyCell ng-star-inserted text-md-center" data-margin-bottom="xxsmall" data-height-new="20">
											<fl-bit class="ContentWrapper ng-star-inserted">
												<fl-text _ngcontent-webapp-c239="" class="MobileHeader paragraph ng-star-inserted" data-margin-right="xxsmall">
													<div class="NativeElement ng-star-inserted">Expired</div>
												</fl-text>
												<div class="ng-star-inserted">
													<span style="background:#D1D1D1;padding:5px 8px;border-radius:3px;color:#000 !important;font-size:12px">Expired</span>
												</div>
											</fl-bit>
										</td>
									</tr>
