    ...
    <div id="nav-main" class="nav-collapse-1">
      <div class="nav-left nav-align nav-d-flex flex-1 nh-search">
        ...
        @if (Route::has('register'))
          <a class="nav-item login-link d-none d-lg-block px-0 px-20" href="{{ route('register') }}">Sign Up</a>
        @endif
        <a class="nav-item login-link d-none d-lg-block px-0 px-20" href="{{ route('login') }}">Log In</a>
      </div>
    </div>
  </div>
</div>