            ...
            <table border="0" cellpadding="20" style="width:100%;padding-bottom: 0px;background-color: #fff;">
                        ...
                        <table border="0" cellpadding="20" cellspacing="0" style="width:100%;padding-bottom:0px;">
                            ...
                            <tr>
                                <td style="padding: 20px 0 20px 0;text-align:center;color:#7F8FA4;font-family: 'Lato', sans-serif;font-size: 16px;font-weight:400;">
                                    If you did not make this request, just ignore this email. Otherwise, <br/>
                ...
                <tr>
                    <td style="padding: 0 0 20px 0;text-align:center;color:#7F8FA4;font-family: 'Lato', sans-serif;font-size: 16px;font-weight:400;">
                        © 2019 Social Sound. All rights reserved.
                    </td>
                </tr>
                <td style="padding: 0 0 20px 0;text-align:center;color:#7F8FA4;font-family: 'Lato', sans-serif;font-size: 16px;font-weight:400;">
                    <a href="" style="color:#5C7CE5;font-size: 20px;padding-right: 10px;"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                    <a href="" style="color:#5C7CE5;font-size: 20px;padding-right: 10px;"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                    <a href="" style="color:#5C7CE5;font-size: 20px;padding-right: 10px;"><i class="fa fa-linkedin" aidden="true"></i></a>
                    <a href="" style="color:#5C7CE5;font-size: 20px;"><i class="fa  fa-pinterest-p" aria-hidden="true"></i></a>
                </td>
                </tr>
                </tr>
                </td>
