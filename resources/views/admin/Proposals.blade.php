			...
			<div class="col-lg-12">
				<div class="card">
					<div class="card-header py-3">
						<div class="row">
	                    	<div class="col">
	                    		<h3 class="m-0 font-weight-bold text-primary">Proposals List</h3>
	                    	</div>
	                    </div>
					</div>
					<div class="card-body">
						...
						<table class="table table-responsive-sm table-bordered table-striped table-sm">
							...
							<tbody>
								<tr>
									<td>
										<a href="#">I Will Desgin Website i'am Profisinal working</a>
									</td>
									<td>8 Dec, 2020</td>
									<td>15.00$</td>
									<td>
									...
									<td>
										<button type="button" name="delete_button" class="btn btn-warning btn-circle btn-sm edit_button" data-id="3" data-status="Enable">
